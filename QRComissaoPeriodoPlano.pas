{ Programa ........: Relatório por Vendas p/ Período p/ Plano }
{ Cliente .........: MultiOdonto                              }
     ...
     with QueryVendas do
       begin
         ...
         if Representante <> 0 then
            ...
            // filtra se é quer plano pj ou pf ou os dois.
            if TpPessoaPlano <> 'T' then
            begin
              //FormRelComissao.memo1.lines.add(text);
               case TpPessoaPlano of

                 'F': sql[13] := ' and d5.Fis_Jur = ''Física'' ' + sql[13];
                 'J': sql[13] := ' and d5.Fis_Jur = ''Jurídica'' ' + sql[13];
               end;
            end;
