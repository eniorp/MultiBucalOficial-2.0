...
begin
  inherited;
   ...
   begin
     ...
     begin
        ShowMessage('Orcamento já incluso');
        exit;
     end;
     ADOQueryH.Close;
     ...
     begin
        ShowMessage('Orcamento não localizado, ou não autorizado, verifique! ');
        Edit1.setFocus;
        Edit1.SelectAll;
        exit;
     end;
...
begin
   ...
   QrViaConv.QRLabel22.caption := 'ESTE ORÇAMENTO FOI APROVADO EM : ' + dtConferencia +
   ...
   if tpOrcamento = 7 then // renovação
...
begin
  inherited;
  if Application.MessageBox('Confirma a impressão dos orçamentos','Impressão',MB_OKCANCEL + MB_DEFBUTTON2) <> IDOK then
     exit;
  For I := 0 to ListView.Items.Count - 1 do
  begin
