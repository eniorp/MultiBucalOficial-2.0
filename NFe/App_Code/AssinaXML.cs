...
// e o devido crédito.
//
// Acesse hhtp://NF-eletronica.com/blog para obter obter mais Informações Técnicas do Projeto Nota Fiscal eletônica.
//    
    ...
    public class AssinaturaDigital
    {
        ...
        public X509Certificate2 getCertificado(string serialNumber)
        {
            ...
            foreach (X509Certificate2 cert in lcerts)
            {
                ...
                {
                    if (cert.SerialNumber.Equals(serialNumber))
                    {
                        rs = cert;
                    }
