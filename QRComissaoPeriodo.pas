...
type
  TQRListaComissaoPeriodo = class(TQuickRep)
    TitleBand1: TQRBand;
...
var
  QRListaComissaoPeriodo: TQRListaComissaoPeriodo;
...
procedure TQRListaComissaoPeriodo.QuickRepBeforePrint(
...
procedure TQRListaComissaoPeriodo.DetailBand1BeforePrint(
...
procedure TQRListaComissaoPeriodo.Verifica_PrecoGrupo;
begin
...
procedure TQRListaComissaoPeriodo.Verifica_PrecoPlano;
begin
...
procedure TQRListaComissaoPeriodo.QRGroup2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
     Vidas_Vendedor := 0;
     Valor_Vendedor := 0;
...
procedure TQRListaComissaoPeriodo.QRBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
     QRLabelVidasVendedor.Caption := IntToStr(Vidas_Vendedor);
end;

procedure TQRListaComissaoPeriodo.QRGroup1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TQRListaComissaoPeriodo.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
     QRLabelVidasRepresentante.Caption := IntToStr(Vidas_Representante);
end;

procedure TQRListaComissaoPeriodo.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
