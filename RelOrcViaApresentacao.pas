...
procedure TQrViaApres.SummaryBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TQrViaApres.DetailBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
   if  QueryOrcamento.FieldByName('tx_evento').AsString <> '' then
       QrViaApres.DetailBand1.Height := 50
   else
      QrViaApres.DetailBand1.Height := 16;
end;
