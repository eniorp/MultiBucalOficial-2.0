...
type
  TQRListaVendasPeriodoSintetico = class(TQuickRep)
    TitleBand1: TQRBand;
...
var
  QRListaVendasPeriodoSintetico: TQRListaVendasPeriodoSintetico;
...
procedure TQRListaVendasPeriodoSintetico.QuickRepBeforePrint(
...
procedure TQRListaVendasPeriodoSintetico.DetailBand1BeforePrint(
...
procedure TQRListaVendasPeriodoSintetico.Verifica_PrecoGrupo;
begin
...
procedure TQRListaVendasPeriodoSintetico.Verifica_PrecoPlano;
begin
...
procedure TQRListaVendasPeriodoSintetico.QRGroup2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
     Vidas_Vendedor := 0;
     Valor_Vendedor := 0;
...
procedure TQRListaVendasPeriodoSintetico.QRBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TQRListaVendasPeriodoSintetico.QRGroup1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TQRListaVendasPeriodoSintetico.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TQRListaVendasPeriodoSintetico.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var Media : Currency;
begin
...
procedure TQRListaVendasPeriodoSintetico.Verifica_Desconto;
begin
     Valor_Desconto := 0;
