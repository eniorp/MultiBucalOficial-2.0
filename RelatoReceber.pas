     ...
     case RadioGroupRelatorioReceber.ItemIndex of
        ...
        7 :
          begin
            ...
            FmFrRelResumoBaixaPorData := TFmFrRelResumoBaixaPorData.create(senha.Empresa,'RESUMO DE TÍTULOS BAIXADOS POR DATA',self);                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     FmFrRelResumoBaixaPorData.AdoQueryResumo.sql[13]:= 'and (nro_cheque<>''y'' or nro_cheque is null) group by descricao_tipopgto';
