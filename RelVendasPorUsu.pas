...
begin
  ...
  QRLabelQtPagaVistaRep.Caption :=   dm.execmd('select count(*) qt from contratante c, vendedor v where v.Codigo = c.Vendedor and c.PagtoContratoAVista = 1 and c.exclusao is null and c.inclusao between ' +  QueryVendasUsu.SQL[35] +  ' and v.Representante = ' + QueryVendasUsu.FieldByName('cdrepres').AsString , 'qt');
