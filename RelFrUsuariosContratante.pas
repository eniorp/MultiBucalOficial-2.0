...
procedure TFrListaUsuarioContratante.RLBand2BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
   // tacio 17/10/2020: retirei essa linha pois estava deixando de somar quando
   //quebrava pagina.
   //ttContrat := 0;
end;
...
procedure TFrListaUsuarioContratante.RLBand3BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
     // coloquei aqui porque no evento RLBand4BeforePrint nao funciona.. para entender o bug só colocar o RLDBText10 RLBand4 veras que nao sai o nome correspondente.  
